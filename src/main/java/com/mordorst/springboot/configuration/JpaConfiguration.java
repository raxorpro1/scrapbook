package com.mordorst.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.mordorst.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.mordorst.springboot.model" });
